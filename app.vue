...
import WTriggerButton from './components/WTriggerButton.vue';
import { type Options, type Step } from './plugins/walkthrough.client';

const steps = reactive<Step[]>([
  {
    element: '.get-started-gradient-border',
...
<template>
  <div>
    <NuxtRouteAnnouncer />
    <NuxtWelcome />
    <WTriggerButton position="bottom-left" @start="start">Start!</WTriggerButton>
  </div>
</template>
